...
1.        Solution Architecture:        4

2.        Terraform:        5

3.        Kubernetes:        5

3.1.        Why Kubernetes?        5

4.        ELK Stack:        5

4.1.        Elasticsearch        6

4.2.        Logstash — Routing Your Log Data        6

4.3.        Kibana — Visualizing Your Log Data        7

4.4.        Beats —  Lightweight Data Shippers        7

4.5.        The following logs are visualized in Kibana:        8

5.        Jenkins:        8

5.1.        Plugins:        8

5.1.1.        Kubernetes Continuous Deploy plugin:        8

5.2.        Jenkins Pipeline        9

6.        Azure Storage Account:        9

7.        Chef Habitat:        10

7.1.        Why Habitat?        10

7.2.        Packaging an Application with Habitat:        10

7.3.        Habitat Components:        10

7.4.        Habitat Packaging Format:        11

7.5.        Habitat Highlights:        11

8.        Prerequisites:        12

8.1.        Generate your SSH key:        12

8.2.        Create Service principal        14

9.        Deploy the ARM Template:        16

10.        Environment Details:        21

11.        Solution Workflow:        22

11.1.        Jobs        27

11.2.        Executing the Jobs        28

11.2.1.        ELKJob        28

11.2.2.        KubernetesClusterjob        28

11.2.3.        VMSSjob        28

12.        Chef Habitat:        33

12.1        Configuring Habitat:        33

12.2        Creating Hart File:        35

12.3 Get Azure Container Registry Password from Azure portal        36

12.4 Uploading MongoDB HART file to Azure Container Registry:        38

12.5        Uploading National parks HART File to the Azure Container Registry:        38

12.6 Verify Docker Images in Azure Container Registry:        39

12.7        Run VMSS Job:        40

12.7 Verify Kubernetes Pods and Services:        43

12.8 Access National Park Applications        44

12.9        Verifying Application Logs:        45
